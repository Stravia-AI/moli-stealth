...
mod tests {
    ...
    fn renderer_runtime_inspector_session_id_tracks_owner_session_kind() {
        ...
        assert_eq!(attached_route.session_id(), Some("SID-active-aux"));
    ...
    fn connection_runtime_slot_reference_reads_and_mutates_active_background_and_attached_slots() {
        ...
        active
            ...
            .log_enabled = true;
        assert!(
            active.assign_attached_session_to_target(
                "TID-background",
        ...
        assert!(
            inactive
                .assign_attached_session_to_target("TID-inactive", "SID-aux-inactive".to_owned())
        );
